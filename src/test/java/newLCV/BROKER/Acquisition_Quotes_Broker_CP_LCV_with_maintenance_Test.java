...
public class Acquisition_Quotes_Broker_CP_LCV_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_user_flow_broker_CP_quote_summary_values_verification_with_maintenance_test(String manufacturer, String model, String vehicle_profit, String sales_price_percentage,
		...
		boolean quote_summary_page_otr_value_check = obj_quote_summary_page.quote_summary_broker_CP_with_maintenance(sheet_name);
	...
	public Object[][] getTestData() throws IOException {		
		Object[][] data=ReadExcelData.getTestData("BrokerCPwithMaint_LCV");
		return data;
	}
