...
public class Acquisition_Quotes_Broker_FL_LCV_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_user_flow_broker_pch_OTR_calculation_with_maintenance_test(String manufacturer,
			...
			String monthlyMaintenanceRental, String finalBallonPayment, String pensePerExcessMileFinance,
			String pensePerExcessMileMaintenance, String percentageOfSaleProceedsOfCustomer,
			String secondaryHirePeriodRental, String commission, String partExchangeActual, String partExchangeGiven,
		...
		boolean subtotal_after_discount = obj_contract_types_and_OTR_page
				.contractTypes_and_OTR_selection_broker_fl(sheet_name);
	...
	public void aquisition_quotes_user_flow_broker_pch_after_discount_calculation_with_maintenance_test(
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_user_flow_broker_pch_after_discount_calculation_with_maintenance_test" })

	public void aquisition_quotes_user_flow_broker_pch_funder_quote_addition_with_maintenance_test(String manufacturer,
			String model, String quoteRef, String quoteExpiryDate, String term, String milesperannum,
			String initialFinanceRental, String initialMaintenanceRental, String monthlyFinanceRental,
			String monthlyMaintenanceRental, String finalBallonPayment, String pensePerExcessMileFinance,
			String pensePerExcessMileMaintenance, String percentageOfSaleProceedsOfCustomer,
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_user_flow_broker_pch_funder_quote_addition_with_maintenance_test" })
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("BrokerFLwithMaint_LCV");
		return data;
