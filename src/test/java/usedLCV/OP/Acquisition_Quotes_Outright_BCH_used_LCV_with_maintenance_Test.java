...
public class Acquisition_Quotes_Outright_BCH_used_LCV_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_Outright_BCH_used_LCV_OTR_calculation_with_maintenance_test(String registrationNumber,
	...
	@Test(priority = 2, dataProvider = "testData" , dependsOnMethods = {
			"aquisition_quotes_Outright_BCH_used_LCV_OTR_calculation_with_maintenance_test" })
	public void aquisition_quotes_Outright_BCH_used_LCV_edit_cost_price_and_check_OTR_with_maintenance_test(String registrationNumber,
			String mileage, String vehicelCostPrice, String options_and_preparation_cost, String percentage_cap_residual_value_used,
			String percentage_cap_maintenance_cost_used, String residual_value_used, String main_cost_used,
			String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
			String less_finance_settlement_from_excel, String order_deposit_from_excel, String document_fee_from_excel,
...
//		Assert.assertTrue(cost_price_ex_vat_and_options_and_preparation_cost);
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_Outright_BCH_used_LCV_edit_cost_price_and_check_OTR_with_maintenance_test" })

	public void aquisition_quotes_Outright_BCH_used_LCV_holding_cost_calculations_with_maintenance_test(String registrationNumber,
			String mileage, String vehicelCostPrice, String options_and_preparation_cost, String percentage_cap_residual_value_used,
			String percentage_cap_maintenance_cost_used, String residual_value_used, String main_cost_used,
			String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
			String less_finance_settlement_from_excel, String order_deposit_from_excel, String document_fee_from_excel,
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_Outright_BCH_used_LCV_holding_cost_calculations_with_maintenance_test" })
...
//		Assert.assertTrue(cust_quote_for_all_payment_boolean_status);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("OP_BCH_withMaint_used_LCV");
		return data;
	}
