...
public class Acquisition_Quotes_CP_PCH_used_LCV_without_maintenance_Test extends TestBase {
...
//		Assert.assertTrue(cust_quote_for_all_payment_boolean_status);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("CP_PCH_withoutMaint_used_car");
		return data;
	}
