...
public class Acquisition_Quotes_Broker_CP_used_LCV_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_user_flow_broker_CP_quote_summary_values_verification_with_maintenance_test(String registrationNumber,
		...
		boolean quote_summary_page_status = obj_quote_summary_page.quote_summary_broker_CP_check_maintenance_values_displayed(monthlyFinancePayment, monthlyMaintenancePayment,sheet_name);
