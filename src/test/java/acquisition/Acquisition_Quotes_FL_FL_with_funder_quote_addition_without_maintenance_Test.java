...
public class Acquisition_Quotes_FL_FL_with_funder_quote_addition_without_maintenance_Test extends TestBase {
	...
	QuoteSummary_HPNR_BCHPage obj_quote_summary_page_HPNR_BCH_page ;
	...
	public void aquisition_quotes_FL_FL_quote_summary_values_verification_without_maintenance_test(String manufacturer, String model,
		...
		obj_quote_summary_page_HPNR_BCH_page = new QuoteSummary_HPNR_BCHPage();
		
		obj_quote_summary_page_HPNR_BCH_page.quote_summary_HPNR_BCH_without_maintenance("FL_FL_Funder_Quote_Save");
		
		obj_holding_cost_HPNR_BCH_page = new HoldingCost_HPNR_BCHPage();
		
		obj_holding_cost_HPNR_BCH_page.save_maint_value_to_excel_for_with_funder_scenario(expiryDate, "FL_FL_Funder_Quote_Save");
