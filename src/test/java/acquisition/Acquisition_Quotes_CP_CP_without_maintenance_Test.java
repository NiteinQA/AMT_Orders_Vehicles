...
public class Acquisition_Quotes_CP_CP_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_CP_CP_quote_summary_values_verification_without_maintenance_test(String manufacturer, String model
		...
		obj_quote_summary_page_hpnr_pcp.quote_summary_purchase_without_maintenance("CP_CP_Quote_Save");
		
		
		HoldingCost_HPNR_HPRPage obj_holding_cost_page = new HoldingCost_HPNR_HPRPage();
		
		obj_holding_cost_page.save_maint_value_to_excel_for_without_funder_scenario("CP_CP_Quote_Save");
