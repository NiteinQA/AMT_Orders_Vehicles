...
public class Acquisition_Quotes_HPNR_BCH_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_BCH_other_support_check_without_maintenance_test(String manufacturer,
		...
		System.out.println("");
		  ...
		  boolean otr_price_check =
		  obj_contract_types_and_OTR_page.verify_other_support_calculations(
		  other_support_value, sheet_name);
...
//		Assert.assertTrue(holding_cost_after_editing_additional_terms_and_mileage);
	...
	public void aquisition_quotes_HPNR_BCH_customer_quote_payment_profile_calculations_without_maintenance_test(
		...
		System.out.println("");
		  ...
		  boolean monthly_rental_values_on_updating_upsell_value
