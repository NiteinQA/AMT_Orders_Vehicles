...
public class Acquisition_Quotes_CP_CP_with_funder_quote_addition_without_maintenance_Test extends TestBase {
	...
	QuoteSummary_HPNR_PCP_Page obj_quote_summary_page_hpnr_pcp;
		...
		boolean monthly_finance_payment_check = obj_customer_quote_page
		 ...
		 Assert.assertTrue(monthly_finance_payment_check);
		  ...
		  (String manufacturer,
					...
					String order_deposit_from_excel, String finance_deposit, String document_fee_from_excel, String upsell,
					String maintenance_required, String maintenance_margin, String initial_payment, String part_exchange_status,
					String target_rental, String matrix_credit_type, String balloon_payment_status, String sheet_name) throws
...
//			obj_quote_summary_page.save_quote();
			...
			obj_quote_summary_page_hpnr_pcp = new QuoteSummary_HPNR_PCP_Page();
			
			obj_quote_summary_page_hpnr_pcp.quote_summary_purchase_without_maintenance("CP_CP-Funder_Quote_Save");
			
			HoldingCost_HPNR_HPRPage obj_holding_cost_page = new HoldingCost_HPNR_HPRPage();
			
			obj_holding_cost_page.save_maint_value_to_excel_for_with_funder_scenario(term , expiryDate, "CP_CP-Funder_Quote_Save");
