...
public class Acquisition_Quotes_HPNR_BCH_edit_flow_with_maintenance_Test extends TestBase {
	...
	public void open_saved_quote_and_edit_road_tax_for_first_year(
			String vehicle_basic_price, String road_tax_for_first_year, String other_support_value,
			...
			String target_rental, String quote_no_excel_sheet_name, String calculation_excel_sheet_name)
		...
		obj_contract_types_and_OTR_page.edit_road_tax_for_first_year_on_otr_page(road_tax_for_first_year, calculation_excel_sheet_name);
...
//	}
	...
	public void open_quote_summary_and_verify_values_after_editing_road_tax_for_first_year(
			String vehicle_basic_price, String road_tax_for_first_year, String other_support_value,
			String percentage_cap_residual_value_used, String percentage_cap_maintenance_cost_used,
			String residual_value_used, String main_cost_used, String actual_part_exchange_value_from_excel,
			String given_part_exchange_value_from_excel, String less_finance_settlement_from_excel,
		...
		boolean quote_summary_OTR_calculation = obj_quote_summary_page.quote_summary_OTR_calculation(calculation_excel_sheet_name);
		...
		boolean quote_summary_OTR_calculation1 = obj_quote_summary_page.quote_summary_OTR_calculation(calculation_excel_sheet_name);
		...
		boolean balance_due1 = obj_quote_summary_page.verify_balance_due_value(calculation_excel_sheet_name);
		...
		boolean value_check_after_Base_Int_change = obj_quote_summary_page
				.quote_summary_edit_base_int_rate_value_verification_with_maintenance(calculation_excel_sheet_name);
		...
		boolean value_check_after_Finance_margin_change = obj_quote_summary_page
				.quote_summary_edit_finance_margin_value_verification(calculation_excel_sheet_name);
		...
		boolean value_check_after_maint_margin_change = obj_quote_summary_page
				.quote_summary_edit_maintenance_margin_value_verification(calculation_excel_sheet_name);
