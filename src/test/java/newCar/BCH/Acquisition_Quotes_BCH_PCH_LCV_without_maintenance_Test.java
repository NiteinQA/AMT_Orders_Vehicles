...
public class Acquisition_Quotes_BCH_PCH_LCV_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_BCH_PCH_customer_quote_payment_profile_calculations_without_maintenance_test(String manufacturer, String model,
		...
		boolean customer_quote_for_payment_boolean = obj_customer_quote_page.customer_Quote_BCH_PCH_for_one_payment_option_without_maintenance_calculation(actual_part_exchange_value_from_excel, 
				given_part_exchange_value_from_excel, less_finance_settlement_from_excel, order_deposit_from_excel, document_fee_from_excel, matrix_upsell, maintenance_required, maintenance_margin, initial_payment, part_exchange_status, target_rental, sheet_name);
...
//		LO.print("****************************************************************");
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("BCH_PCH_withoutMaint_LCV");
		return data;
	}
