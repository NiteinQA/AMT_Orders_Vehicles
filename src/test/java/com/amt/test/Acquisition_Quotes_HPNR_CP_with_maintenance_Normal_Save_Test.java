...
public class Acquisition_Quotes_HPNR_CP_with_maintenance_Normal_Save_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_CP_quote_summary_values_verification_with_maintenance_test(String manufacturer, String model, 
		...
		boolean quote_summary_value_check =obj_quote_summary_page.quote_summary_HPNR_CP_with_maintenance(sheet_name);		
