...
public class Acquisition_Quotes_HPNR_CP_without_maintenance_Normal_Save_Test extends TestBase {
	...
	@Test(priority=7, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_CP_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test" })
