...
public class Acquisition_Quotes_FL_BCH_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_FL_BCH_holding_cost_calculations_with_maintenance_test(String manufacturer, String model, 
		...
		boolean holding_cost_with_maintenance_boolean = obj_holding_cost_FL_BCH_page
	...
	public void aquisition_quotes_FL_BCH_customer_quote_payment_profile_calculations_with_maintenance_test(String manufacturer, String model, 
		...
		boolean cust_quote_for_one_payment_boolean_status=obj_customer_quote_page.customer_Quote_FL_BCH_for_one_payment_option_with_maintenance_calculation( actual_part_exchange_value_from_excel,
		...
		boolean cust_quote_for_all_payment_boolean_status=obj_customer_quote_page.customer_Quote_FL_BCH_for_all_payment_option_with_maintenance_calculation(initial_payment,sheet_name);
	...
	public void aquisition_quotes_FL_BCH_quote_summary_values_verification_with_maintenance_test(String manufacturer, String model, 
		...
		boolean quote_summary_page_status = obj_quote_summary_page.quote_summary_FL_BCH_with_maintenance(sheet_name);
