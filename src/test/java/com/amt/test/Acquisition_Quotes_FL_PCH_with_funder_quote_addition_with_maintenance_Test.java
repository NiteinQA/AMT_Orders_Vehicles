...
public class Acquisition_Quotes_FL_PCH_with_funder_quote_addition_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_FL_PCH_customer_quote_payment_profile_calculations_with_maintenance_test(String manufacturer, String model,
		...
		boolean cutomer_quote_monthly_rental = obj_customer_quote_page
				.customer_Quote_FL_PCH_for_all_payment_option_for_funder_quote_addition_with_maintenance_calculation(initial_payment,sheet_name);
	...
	public void aquisition_quotes_FL_PCH_quote_summary_values_verification_with_maintenance_test(String manufacturer, String model,
		...
		boolean quote_summary_page_status = obj_quote_summary_page.quote_summary_FL_PCH_for_funder_quote_with_maintenance(sheet_name);
