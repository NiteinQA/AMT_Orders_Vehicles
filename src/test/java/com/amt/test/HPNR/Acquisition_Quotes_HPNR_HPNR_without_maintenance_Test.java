...
public class Acquisition_Quotes_HPNR_HPNR_without_maintenance_Test extends TestBase {
	...
	@Test(priority=2, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_OTR_calculation_without_maintenance_test" })
	...
	@Test(priority=3, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_after_discount_calculations_without_maintenance_test" })
	...
	@Test(priority=4, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_holding_cost_calculations_without_maintenance_test" })
	...
	@Test(priority=5, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test" })
	...
	@Test(priority=6, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_customer_quote_vehicle_profit_edit_check_without_maintenance_test" })
	...
	@Test(priority=7, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_customer_quote_part_exchange_value_edit_check_without_maintenance_test" })
	...
	public void aquisition_quotes_HPNR_HPNR_quote_summary_values_verification_without_maintenance_test(String manufacturer, String model
		...
		boolean quote_summary_value_check =obj_quote_summary_page.quote_summary_HPNR_HPNR_without_maintenance(sheet_name);		
