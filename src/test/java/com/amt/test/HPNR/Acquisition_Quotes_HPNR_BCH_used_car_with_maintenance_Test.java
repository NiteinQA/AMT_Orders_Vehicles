...
public class Acquisition_Quotes_HPNR_BCH_used_car_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_BCH_used_car_OTR_calculation_with_maintenance_test(String registrationNumber, String mileage, String vehicelCostPrice, String rfl
		...
		boolean cost_price_ex_vat_and_rfl = obj_contract_types_and_OTR_page
				.contractTypes_selection_and_OTR_calculation();
		Assert.assertTrue(cost_price_ex_vat_and_rfl);	
		
	}
	
	@Test(priority = 2, dataProvider = "testData")	
	public void aquisition_quotes_HPNR_BCH_used_car_edit_cost_price_and_check_OTR_with_maintenance_test(String registrationNumber, String mileage, String vehicelCostPrice, String rfl
			 ) throws InterruptedException, IOException, UnsupportedFlavorException {

		boolean cost_price_ex_vat_and_rfl = obj_contract_types_and_OTR_page
				.edit_vehicle_cost_price_and_check_OTR_price(vehicelCostPrice, rfl);
		Assert.assertTrue(cost_price_ex_vat_and_rfl);
	 ...
	 * String manufacturer, String model, String road_tax_for_first_year, String
	 * on_road_price_for_invoice, String percentage_cap_residual_value_used, String
	 * percentage_cap_maintenance_cost_used, String residual_value_used ,String
	 * main_cost_used, String actual_part_exchange_value_from_excel, String
	 * given_part_exchange_value_from_excel, String
	 * less_finance_settlement_from_excel, String order_deposit_from_excel, String
	 * document_fee_from_excel, String upsell, String maintenance_required, String
	 * maintenance_margin, String initial_payment, String part_exchange_status,
	 * String target_rental,String sheet_name ) throws InterruptedException,
	 ...
	 * .verify_holding_cost_with_maintenance(percentage_cap_maintenance_cost_used,
	 * residual_value_used, main_cost_used, percentage_cap_residual_value_used,
	 ...
	 * less_finance_settlement_from_excel, order_deposit_from_excel,
	 * document_fee_from_excel, upsell, maintenance_required, maintenance_margin,
	 * initial_payment, part_exchange_status, target_rental, sheet_name);
	 * 
	 * Assert.assertTrue(cust_quote_for_one_payment_boolean_status);
	 * 
	 * boolean monthlyFinanceAndMaintenanceWithPartExchange =
	 ...
	 * customer_Quote_HPNR_BCH_for_all_payment_option_with_maintenance_calculation(
	 ...
	 * 
	 * public void
	 * aquisition_quotes_HPNR_BCH_quote_summary_values_verification_with_maintenance_test
	 * (String manufacturer, String model, String road_tax_for_first_year, String
	 * on_road_price_for_invoice, String percentage_cap_residual_value_used, String
	 * percentage_cap_maintenance_cost_used, String residual_value_used ,String
	 * main_cost_used, String actual_part_exchange_value_from_excel, String
	 ...
	 * 
	 * boolean quote_summary_OTR_calculation =
	 * obj_quote_summary_page.quote_summary_OTR_calculation(sheet_name);
	 ...
	 * quote_summary_customer_quote_summary_value_verification_with_maintenance(
	 * sheet_name); //Assert.assertTrue(quote_summary_customer_quote_calculation);
	 * 
	 ...
	 * 
	 * boolean quote_summary_OTR_calculation1 =
	 * obj_quote_summary_page.quote_summary_OTR_calculation(sheet_name);
	 ...
	 * sheet_name); Assert.assertTrue(value_check_after_Base_Int_change);
	 * 
	 * boolean value_check_after_Finance_margin_change
	 * =obj_quote_summary_page.quote_summary_edit_finance_margin_value_verification(
	 * sheet_name); //Assert.assertTrue(value_check_after_Finance_margin_change);
	 * 
