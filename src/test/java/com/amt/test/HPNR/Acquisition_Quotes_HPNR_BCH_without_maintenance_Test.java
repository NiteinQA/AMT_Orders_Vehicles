...
public class Acquisition_Quotes_HPNR_BCH_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_BCH_customer_quote_payment_profile_calculations_without_maintenance_test(String manufacturer, String model,
		...
		boolean cutomer_quote_monthly_rental = obj_customer_quote_page
				.customer_Quote_HPNR_BCH_for_all_payment_option_without_maintenance_calculation(initial_payment,sheet_name);
	...
	public void aquisition_quotes_HPNR_BCH_quote_summary_values_verification_without_maintenance_test(String manufacturer, String model,
		...
		boolean quote_summary_page_status = obj_quote_summary_page.quote_summary_HPNR_BCH_without_maintenance(sheet_name);
