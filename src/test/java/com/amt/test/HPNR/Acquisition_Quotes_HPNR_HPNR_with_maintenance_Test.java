...
public class Acquisition_Quotes_HPNR_HPNR_with_maintenance_Test extends TestBase {
	...
	@Test(priority=2, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_OTR_calculation_with_maintenance_test" })
	...
	@Test(priority=3, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_after_discount_calculations_with_maintenance_test" })
	...
	@Test(priority=4, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_holding_cost_calculations_with_maintenance_test" })
	...
	@Test(priority=5, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_customer_quote_calculations_check_monthly_finance_payment_with_maintenance_test" })
	...
	@Test(priority=6, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_customer_quote_vehicle_profit_edit_check_with_maintenance_test" })
	...
	@Test(priority=7, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_customer_quote_part_exchange_value_edit_check_with_maintenance_test" })
