...
public class Acquisition_Quotes_HPNR_CP_with_funder_quote_addition_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_CP_after_discount_calculations_without_maintenance_test(String manufacturer,
	...
	public void aquisition_quotes_HPNR_CP_holding_cost_calculations_without_maintenance_test(String manufacturer,
			String model, String quoteRef, String expiryDate, String term, String milesPerAnnum, String cashDeposit,
			String financeCharges, String documentFee, String monthlyPayment, String finalBallonPayment,
			String optionToPurchaseFee, String actual_part_exchange_value_from_excel,
			String given_part_exchange_value_from_excel, String less_finance_settlement_from_excel,
	...
	public void aquisition_quotes_HPNR_CP_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test(
		...
		// Assert.assertTrue(monthly_finance_payment_check);
		  ...
		  .quote_summary_HPNR_CP_for_funder_quote_without_maintenance(sheet_name);
