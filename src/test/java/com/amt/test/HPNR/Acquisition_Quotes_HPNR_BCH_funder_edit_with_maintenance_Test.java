...
public class Acquisition_Quotes_HPNR_BCH_funder_edit_with_maintenance_Test extends TestBase {
	...
	@Test(priority=2, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_BCH_OTR_calculation_with_maintenance_test" })
	...
	@Test(priority=3, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_BCH_after_discount_calculations_with_maintenance_test" })
	...
	@Test(priority=4, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_BCH_holding_cost_calculations_with_maintenance_test" })
	...
	@Test(priority=5, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_BCH_customer_quote_payment_profile_calculations_with_maintenance_test" })
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_BCH_funder_edit_withMaintenance");
		return data;
	}
