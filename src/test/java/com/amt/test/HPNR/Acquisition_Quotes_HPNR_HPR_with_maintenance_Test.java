...
public class Acquisition_Quotes_HPNR_HPR_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_HPR_OTR_calculation_with_maintenance_test(String manufacturer, String model,
			...
			String additional_terms, String additional_mileage, String vehicle_profit, String maintenance_status,
	...
	public void aquisition_quotes_HPNR_HPR_holding_cost_calculations_with_maintenance_test(String manufacturer,
		...
		boolean holding_cost_without_maintenance_boolean = obj_holding_cost_page.verify_holding_cost_with_maintenance(
				percentage_cap_maint_value, residual_value_used, maint_cost_used, percentage_cap_residual_value,
