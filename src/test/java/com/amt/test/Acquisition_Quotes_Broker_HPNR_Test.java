...
public class Acquisition_Quotes_Broker_HPNR_Test extends TestBase {
	...
	ContractTypesAndOTR_Broker_HPNR_Page obj_contract_types_and_OTR;
	...
	public void aquisition_quotes_user_flow_broker_HPNR_OTR_calculation_test(String manufacturer, String model,String vehicleProfit,
		 ...
		 obj_contract_types_and_OTR = new ContractTypesAndOTR_Broker_HPNR_Page();
		...
		boolean subtotal_after_discount=obj_contract_types_and_OTR.contractTypes_and_OTR_selection_broker_hpnr(sheet_name);
