...
public class Acquisition_Quotes_Broker_PCH_without_maintenance_edited_Test extends TestBase {
	...
	public void aquisition_quotes_user_flow_broker_PCH_without_maintenance_vehicle_price_edited_test(String manufacturer, String model, 
		...
		boolean subtotal_after_discount=obj_contract_types_and_OTR_Broker_PCH.contractTypes_and_OTR_selection_broker_pch_vehicle_price_edited( vehicleBasicPrice, sheet_name);
		Assert.assertTrue(subtotal_after_discount);
		
	}
	@Test(priority=2, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_user_flow_broker_PCH_without_maintenance_vehicle_price_edited_test" })
	public void aquisition_quotes_user_flow_broker_PCH_without_maintenance_road_tax_for_first_year_edited_test(String manufacturer, String model, 
			String vehicleBasicPrice,String roadTaxForFirstYear, String otrPriceForINvoice, String quoteRef, String quoteExpiryDate,
			String term, String milesperannum,String initialFinanceRental, String monthlyFinanceRental, String pensePerExcessMileFinance,
			String commission, String partExchangeActual, String partExchangeGiven,String lessFinanceSettlement,String oderDeposit, String documentFee,String sheet_name) throws InterruptedException, IOException, UnsupportedFlavorException {
	...
	@Test(priority=3, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_user_flow_broker_PCH_without_maintenance_road_tax_for_first_year_edited_test" })
	public void aquisition_quotes_user_flow_broker_PCH_without_maintenance_customer_quote_funder_quote_addition_test(String manufacturer, String model, 
			String vehicleBasicPrice,String roadTaxForFirstYear, String otrPriceForINvoice, String quoteRef, String quoteExpiryDate,
			String term, String milesperannum,String initialFinanceRental, String monthlyFinanceRental, String pensePerExcessMileFinance,
			String commission, String partExchangeActual, String partExchangeGiven,String lessFinanceSettlement,String oderDeposit, String documentFee,String sheet_name) throws InterruptedException, IOException, UnsupportedFlavorException {
	...
	@Test(priority=4, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_user_flow_broker_PCH_without_maintenance_customer_quote_funder_quote_addition_test" })
