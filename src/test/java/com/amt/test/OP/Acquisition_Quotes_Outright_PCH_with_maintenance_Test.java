...
public class Acquisition_Quotes_Outright_PCH_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_outright_PCH_other_support_check_with_maintenance_test(String manufacturer, String model,
			String road_tax_for_first_year, String on_road_price_for_invoice, String other_support_value,
			String percentage_cap_residual_value_used, String percentage_cap_maintenance_cost_used,
			String residual_value_used, String main_cost_used, String actual_part_exchange_value_from_excel,
			String given_part_exchange_value_from_excel, String less_finance_settlement_from_excel,
	...
	public void aquisition_quotes_outright_PCH_holding_cost_calculations_with_maintenance_test(String manufacturer, String model,
		...
		boolean holding_cost_with_maintenance_boolean = obj_holding_cost_Outright_PCH_page
				.verify_holding_cost_with_maintenance(percentage_cap_maintenance_cost_used, residual_value_used,
						main_cost_used, percentage_cap_residual_value_used, maintenance_required, target_rental,
						sheet_name);
