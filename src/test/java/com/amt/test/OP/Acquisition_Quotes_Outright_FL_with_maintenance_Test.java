...
public class Acquisition_Quotes_Outright_FL_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_outright_FL_holding_cost_calculations_with_maintenance_test(String manufacturer, String model,
		...
		boolean holding_cost_before_editing_percentage_values = obj_holding_cost_Outright_FL_page.verify_holding_cost_before_editing_cap_data_with_maintenance(
		...
		boolean holding_cost_after_editing_percentage_values  = obj_holding_cost_Outright_FL_page.edit_percentage_residual_and_maint_cost_then_verify_holding_cost_with_maintenance(
				percentage_cap_maintenance_cost_used, residual_value_used, main_cost_used,
				percentage_cap_residual_value_used, maintenance_required, target_rental, sheet_name);
		Assert.assertTrue(holding_cost_after_editing_percentage_values );
		
		boolean holding_cost_after_editing_residual_and_maint_cost  = obj_holding_cost_Outright_FL_page.edit_residual_value_and_maint_cost_then_verify_holding_cost_with_maintenance(
				percentage_cap_maintenance_cost_used, residual_value_used, main_cost_used,
				percentage_cap_residual_value_used, maintenance_required, target_rental, sheet_name);
