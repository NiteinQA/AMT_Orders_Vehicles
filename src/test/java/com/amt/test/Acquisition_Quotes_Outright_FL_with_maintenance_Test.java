...
public class Acquisition_Quotes_Outright_FL_with_maintenance_Test extends TestBase {
	...
	ContractTypesAndOTR_Outright_FL_Ownbook_CalculationPage obj_contract_types_and_OTR_Outright_FL_page;
	...
	public void aquisition_quotes_outright_FL_OTR_calculation_with_maintenance_test(String manufacturer, String model, 
		...
		obj_contract_types_and_OTR_Outright_FL_page = new ContractTypesAndOTR_Outright_FL_Ownbook_CalculationPage();
		...
		boolean subtotal_after_discount = obj_contract_types_and_OTR_Outright_FL_page
	...
	public void aquisition_quotes_outright_FL_after_discount_calculations_with_maintenance_test(String manufacturer, String model, 
		...
		boolean otr_price_check = obj_contract_types_and_OTR_Outright_FL_page
	...
	public void aquisition_quotes_outright_FL_holding_cost_calculations_with_maintenance_test(String manufacturer, String model, 
		...
		boolean holding_cost_with_maintenance_boolean = obj_holding_cost_Outright_FL_page
	...
	@Test(priority=4, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_outright_FL_holding_cost_calculations_with_maintenance_test" })
	...
	public void aquisition_quotes_outright_FL_customer_quote_payment_profile_calculations_with_maintenance_test(String manufacturer, String model, 
		...
		boolean cust_quote_for_one_payment_boolean_status=obj_customer_quote_page.customer_Quote_outright_FL_for_one_payment_option_with_maintenance_calculation( actual_part_exchange_value_from_excel,
		...
		boolean cust_quote_for_all_payment_boolean_status=obj_customer_quote_page.customer_Quote_outright_FL_for_all_payment_option_with_maintenance_calculation(initial_payment,sheet_name);
		Assert.assertTrue(cust_quote_for_all_payment_boolean_status);
		
	}
	
	@Test(priority=5, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_outright_FL_customer_quote_payment_profile_calculations_with_maintenance_test" })
