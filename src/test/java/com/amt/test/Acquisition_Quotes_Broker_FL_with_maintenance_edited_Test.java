...
public class Acquisition_Quotes_Broker_FL_with_maintenance_edited_Test extends TestBase {
	...
	public void aquisition_quotes_user_flow_broker_fl_vehicle_price_edited_with_maintenance_test(String manufacturer, String model,
			...
			String percentageOfSaleProceedsOfCustomer, String secondaryHirePeriodRental,
	...
	public void aquisition_quotes_user_flow_broker_fl_customer_quote_funder_quote_addition_with_maintenance_test(String manufacturer, String model,
		...
		boolean customer_quote_check=obj_customer_quote_page.customer_Quote_broker_fl_with_maintenance(  quoteRef,  quoteExpiryDate,  term,  milesperannum, 
				 ...
				 pensePerExcessMileMaintenance,  percentageOfSaleProceedsOfCustomer,  secondaryHirePeriodRental, commission);	
	...
	public Object[][] getTestData() throws IOException {		
		Object[][] data=ReadExcelData.getTestData("BrokerFLwithMaintenanceEdit");
		return data;	
