...
public class Lead_broker_business_flow_Test extends TestBase {
...
@Test( priority=7)
	...
	public void broker_create_opportunity_business_currentstatus_after_sending_to_contract() throws Exception {	
		obj_Opportunities_Page = new Opportunities();
		...
		// Opportunity listing screen - Proposal status  
					 ...
					 * 
					 * // Opportunity listing screen - Proposal status
					 * obj_Opportunities_Page.opp_find_listing_button();
					 * 
					 * 
					 * 
					 * 
