...
public class Acquisition_Quotes_CP_CP_without_maintenance_Normal_Save_Test extends TestBase {
	...
	@Test(priority=7, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_CP_CP_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test" })
	...
	public void aquisition_quotes_CP_CP_quote_summary_values_verification_without_maintenance_test(String manufacturer, String model
		...
		boolean quote_summary_value_check =obj_quote_summary_page.quote_summary_CP_CP_without_maintenance(sheet_name);		
