...
public class Acquisition_Quotes_CP_PCP_with_funder_quote_addition_with_maintenance_Test extends TestBase {
	...
	@Test(priority = 5, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_CP_PCP_customer_quote_calculations_check_monthly_finance_payment_with_maintenance_test" })
	...
	public void aquisition_quotes_CP_PCP_quote_summary_values_verification_with_maintenance_test(String manufacturer,
		...
		boolean quote_summary_page_status = obj_quote_summary_page
				.quote_summary_CP_PCP_for_funder_quote_with_maintenance(sheet_name);
