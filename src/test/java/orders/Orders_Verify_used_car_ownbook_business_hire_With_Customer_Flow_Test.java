...
CustomerContractPage obj_customer_contract;
	...
	public void T3_verify_summary_section_values() throws IOException, InterruptedException, AWTException, ClassNotFoundException {
	...
	public void T15_verify_summary_section_values() throws IOException, InterruptedException, AWTException, ClassNotFoundException {
	...
	@Test(priority = 16, dependsOnMethods = { "T15_verify_summary_section_values" })
	public void T16_verify_payment_default_status() throws IOException, InterruptedException, AWTException, ClassNotFoundException {
	...
	@Test(priority = 17, dependsOnMethods = { "T16_verify_payment_default_status" })
	public void T17_make_payment_with_new_payment() throws IOException, InterruptedException, AWTException, ClassNotFoundException {
	...
	@Test(priority = 18, dependsOnMethods = { "T17_make_payment_with_new_payment" })
	public void T18_verify_payment_status_after_making_a_payment_on_customer_contract_tab() throws IOException, InterruptedException, AWTException, ClassNotFoundException {
	...
	@Test(priority = 19, dependsOnMethods = { "T18_verify_payment_status_after_making_a_payment_on_customer_contract_tab" })
	public void T19_verify_delivery_status_after_selecting_date_offered_in_delivery_section_of_customer_contract_tab_test() throws IOException, InterruptedException, AWTException, ClassNotFoundException {
	...
	@Test(priority = 20, dependsOnMethods = { "T19_verify_delivery_status_after_selecting_date_offered_in_delivery_section_of_customer_contract_tab_test" })
	public void T20_verify_delivery_status_after_selecting_confirmed_delivery_date_in_delivery_section_of_customer_contract_test() throws IOException, InterruptedException, AWTException, ClassNotFoundException {
	...
	@Test(priority = 21, dependsOnMethods = { "T20_verify_delivery_status_after_selecting_confirmed_delivery_date_in_delivery_section_of_customer_contract_test" })
	public void T21_verify_delivery_status_after_uploading_delivery_note_in_post_delivery_section_on_customer_contract_tab_test() throws IOException, InterruptedException, AWTException, ClassNotFoundException {
	...
	@Test(priority = 22, dependsOnMethods = { "T21_verify_delivery_status_after_uploading_delivery_note_in_post_delivery_section_on_customer_contract_tab_test" })
	public void T22_verify_delivery_status_on_customer_contract_tab_and_vehicle_order_tab_are_same_when_deliver_to_customer_toggle_button_in_on_test() throws IOException, InterruptedException, AWTException, ClassNotFoundException {
	...
	@Test(priority = 23, dependsOnMethods = { "T22_verify_delivery_status_on_customer_contract_tab_and_vehicle_order_tab_are_same_when_deliver_to_customer_toggle_button_in_on_test" })
