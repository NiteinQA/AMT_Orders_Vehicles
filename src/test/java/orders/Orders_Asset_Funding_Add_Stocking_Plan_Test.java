...
public class Orders_Asset_Funding_Add_Stocking_Plan_Test extends TestBase {
...
VehicleOrderPage obj_vehicle_order_tab;
	...
	public void add_stocking_plan_test() throws IOException, InterruptedException, AWTException {
		
		obj_asset_funding = new AssetFundingPage();
		
		
		assertTrue(obj_asset_funding.stocking_plan());
