...
CustomerContractPage obj_customer_contract;
	...
	@Test(priority = 3, dependsOnMethods = { "T2_pass_the_pre_order_check_test" })
	...
	@Test(priority = 10, dependsOnMethods = { "T9_open_asset_funding_tab_and_verify_default_status_cash_purchase_pending" })
	...
	@Test(priority = 11, dependsOnMethods = { "T10_complete_cash_purchase" })
	...
	@Test(priority = 12, dependsOnMethods = { "T11_verify_status_cash_purchase_completed" })
	...
	@Test(priority = 13, dependsOnMethods = { "T12_verify_default_status_acceptance_conditions_for_outright_purchase_flow" })
	...
	@Test(priority = 14, dependsOnMethods = { "T13_verify_payment_section_values" })
