...
VehicleOrderPage obj_vehicle_order_tab;
	...
	@Test(priority = 5,dataProvider="testData", dependsOnMethods = { "verify_holding_cost_on_editing_residual_value_test" })
	...
	@Test(priority = 6,dataProvider="testData1", dependsOnMethods = { "verify_holding_cost_on_editing_add_term_and_mileage_test" })
