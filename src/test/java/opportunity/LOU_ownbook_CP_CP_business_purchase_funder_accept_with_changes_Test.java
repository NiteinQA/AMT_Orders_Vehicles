...
public class LOU_ownbook_CP_CP_business_purchase_funder_accept_with_changes_Test extends TestBase {
...
//	}
//
//	@Test(priority = 8 ,  dependsOnMethods = {"L6_ownbook_sending_contract" } )
...
//	}
	...
	@Test(priority = 10, dependsOnMethods = { "L9_ownbook_status_after_contract_signed" })
	...
	public void UW1_verify_underwriting_flow_ownbook_with_status() throws Exception {
		...
		boolean underwriting_pop_up_value_verification = obj_Underwriting_Popup_Page
				.verify_underwriting_pop_up_summary_values_for_ownbook_CP_CP_funder_business_purchase_flow();
	...
	public void UW4_verify_ownbook_underwriting_proposal_page_flow() throws Exception {
		...
		boolean quote_tab_status = obj_Underwriting_page
				.verify_quote_tab_on_underwriting_page_for_ownbook_CP_CP_funder_business_purchase_flow();
	...
	public void UW5_verify_ownbook_underwriting_proposal_decision_with_accept() throws Exception {
