...
public class Acquisition_Quotes_Outright_FL_used_car_without_maintenance_Test extends TestBase {
...
//		Assert.assertTrue(cust_quote_for_all_payment_boolean_status);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("Outright_FL_withoutMaint_used_c");
		return data;
	}
