...
public class Acquisition_Quotes_Outright_PCH_used_car_without_maintenance_Test extends TestBase {
...
//		Assert.assertTrue(cust_quote_for_all_payment_boolean_status);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("Outright_PCH_w-o-Maint_used_car");
		return data;
	}
