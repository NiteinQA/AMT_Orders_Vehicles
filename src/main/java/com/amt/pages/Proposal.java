...
private List<WebElement> loading_icon;
	...
	@FindBy(xpath = "//*[@id=\"CustomerdetailscollapseOne1\"]/app-proposal-customer-details/div/div/div/div/div[5]/div[1]/div[1]/ul/li")
...
private WebElement proposal_save ;
 ...
 @FindBy(xpath = "//button[normalize-space()='Update & Exit']")
...

	{
		...
		ExplicitWait.visibleElement(driver, opp_proposal_status, 20);
...

	{
		...
		//proposal_indvidual_gender.clear();
		proposal_indvidual_gender.click();
		...
		Dropdown.selectByVisibleText(driver, proposal_indvidual_nationality, "British", 10);
		...
		ExplicitWait.visibleElement(driver, proposal_indvidual_british_passport_holder, 20);
		...
		Dropdown.selectByVisibleText(driver, proposal_indvidual_Marital_status, "Single", 10);
		...
		ExplicitWait.visibleElement(driver, proposal_indvidual_driving_licence_number, 20);
...
ExplicitWait.visibleElement(driver, proposal_indvidual_postcode, 10);
		
		proposal_indvidual_postcode.clear();
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
	ExplicitWait.visibleElement(driver, proposal_indvidual_value, 10);
		
		Thread.sleep(1000);
		proposal_indvidual_value.click();
		...
		proposal_indvidual_month.clear();
		 proposal_indvidual_month.sendKeys("1");
	...
	//EmpDetail
		...
		//1 EmpDetail_year
		 ...
		 proposal_indvidual_emp_detail_month.sendKeys("1");
			...
			//proposal_indvidual_retired.clear();
		proposal_indvidual_retired.click();
		...
		//1.Regular gross monthly salary
			...
			gross_monthly_salary.clear();
			 gross_monthly_salary.sendKeys("5000");
		...
		// 2.Regular net monthly salary
			...
			ExplicitWait.visibleElement(driver, monthly_rent, 10);
			monthly_rent.clear();
	  ...
	  //1.Account 	
			...
			exact_account_name.clear();
			 exact_account_name	.sendKeys("101010");
			...
			ExplicitWait.visibleElement(driver, sort_code, 10);
			sort_code.clear(); 
	 ...
	 //3.Account number
		...
		ExplicitWait.visibleElement(driver, account_no, 10);
		account_no.clear();
		...
		ExplicitWait.visibleElement(driver, years, 10);
		years.clear();
		years.sendKeys("1");
		...
		ExplicitWait.visibleElement(driver, months, 10);
		months.clear();
			months.sendKeys("1");
		...
		//6.Bank Name
			...
			ExplicitWait.visibleElement(driver, bank_name, 10);
			bank_name.clear();
			...
			ExplicitWait.visibleElement(driver, bank_address, 10);
			bank_address.clear();
	 ...
	 //9.Save 
			...
			ExplicitWait.visibleElement(driver, proposal_save, 10);
			...
			ExplicitWait.visibleElement(driver,  proposal_udpate_and_exit , 15);
