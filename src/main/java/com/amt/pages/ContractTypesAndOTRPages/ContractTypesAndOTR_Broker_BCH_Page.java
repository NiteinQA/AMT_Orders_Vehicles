...
public class ContractTypesAndOTR_Broker_BCH_Page extends TestBase {
	...
	@FindBy(xpath = "//p[normalize-space()='Business Contract Hire']")
	...
	public boolean contractTypes_and_OTR_selection_broker_bch(String sheet_name) throws InterruptedException, IOException {
