...
public class HoldingCost_CP_CP_Page extends TestBase {
	...
	public boolean verify_holding_cost_after_adding_funder_quote_without_maintenance(String quoteRef, String expiryDate ,String term,String milesPerAnnum,String cashDeposit,
			String financeCharges,String documentFee, String monthlyPayment ,String optionalFinalPayment,String optionToPurchaseFee, String pencePerExcessMileFinance,String sheet_name) throws InterruptedException, IOException
	{
		...
		ExplicitWait.waitTillLoadingIconDisappears(driver, loading_icon, 30);	
		 ...
		 obj_read_excel_calculation_page =new ReadExcelCalculationForPurchaseAgreement();
			...
			obj_read_excel_calculation_page =new ReadExcelCalculationForPurchaseAgreement();
		   double monthly_holding_cost_expected=  obj_read_excel_calculation_page.verify_holding_cost_after_adding_funder_without_maintenance_for_cp_purchase( cashDeposit , term, milesPerAnnum, monthlyPayment,
				   optionalFinalPayment, optionToPurchaseFee, documentFee , sheet_name);
	     ...
	     public boolean verify_holding_cost_after_adding_funder_quote_with_maintenance(String quoteRef, String expiryDate,
			...
			String pencePerExcessMileFinance, String pencePerExcessMileMaintenance, String sheet_name)throws InterruptedException, IOException
	{
		Click.on(driver, holding_cost, 30);
	...
	public boolean edit_additional_term_and_mileage_then_verify_holding_cost_without_maintenance(
		...
		return obj_read_excel_calculation_page
				.edit_additional_terms_and_mileage_then_verify_holding_cost_without_maintenance(driver,
						holding_cost_summary_terms, holding_cost_summary_mileage, total_monthly_holding_cost,
						maintenance_required,  residual_value_used_from_screen,
						 sheet_name);
	}
