...
public class HoldingCost_BCH_BCH_Page extends TestBase {
	...
	public boolean verify_holding_cost_without_maintenance(String quoteReference, String quoteExpiryDate,
			String terms,String milesPerAnnum, String maintenance_required,String monthlyFinanceRental, String documentFee, String penceperExcessMileFinance, String sheet_name) throws IOException, InterruptedException {
	    ...
	    obj_read_excel_calculation_page.write_test_data_values_to_excel_for_bch_flow_without_maintenance(quoteReference, quoteExpiryDate, terms, milesPerAnnum, maintenance_required, monthlyFinanceRental, documentFee, penceperExcessMileFinance, sheet_name);
	...
	public boolean verify_holding_cost_with_maintenance(String quoteReference, String quoteExpiryDate,String terms, String milesPerAnnum, String maintenance_required, String  monthlyFinanceRental,String monthlyMaintenanceRental, String documentFee,
			String penceperExcessMileFinance, String penceperExcessMileMaintenance,  String sheet_name) throws IOException, InterruptedException {
		Click.on(driver, holding_cost, 30);
	    ...
	    obj_read_excel_calculation_page.write_test_data_values_to_excel_for_bch_flow_with_maintenance(quoteReference, quoteExpiryDate, terms, milesPerAnnum, maintenance_required, monthlyFinanceRental,monthlyMaintenanceRental, documentFee, penceperExcessMileFinance, penceperExcessMileMaintenance, sheet_name);
