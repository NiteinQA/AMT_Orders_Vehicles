...
//	private WebElement quote_summary_monthly_total_rental;
	...
	@FindBy(xpath = "//strong[normalize-space()='Finance Lease']")
	...
	public boolean quote_summary_broker_fl_without_maintenance(String sheet_name) throws InterruptedException, IOException {
...
//		System.out.println("Customer Quote generated successfully and Quote_ref_no ="+quote_ref_no);
	...
	public boolean quote_summary_broker_fl_with_maintenance(String sheet_name) throws InterruptedException, IOException {
