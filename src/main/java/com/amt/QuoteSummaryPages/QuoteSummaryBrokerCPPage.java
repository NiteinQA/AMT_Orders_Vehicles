...
//	private WebElement quote_summary_monthly_total_rental;
	...
	public boolean quote_summary_broker_CP_without_maintenance(String sheet_name) throws InterruptedException, IOException {
...
//		System.out.println("Customer Quote generated successfully and Quote_ref_no ="+quote_ref_no);
	...
	public boolean quote_summary_broker_CP_with_maintenance(String sheet_name) throws InterruptedException, IOException {
...
public boolean quote_summary_broker_purchase_for_used_vehicle(String sheet_name) throws InterruptedException, IOException {
		...
		return obj_read_excel_calculation_page.verify_quote_summary_values_for_broker_pcp_cp_from_excel_for_used_vehicle(quote_summary_cost_otr_price_from_screen_converted, 
                                              sheet_name);	
	}	
