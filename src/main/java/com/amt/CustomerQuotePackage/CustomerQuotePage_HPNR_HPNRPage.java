...
//		System.out.println("Matrix credit type "+matrix_credit_type+" has been selected" );
	...
	public boolean edit_vehicle_profit_and_check_monthly_finance_payment(String vehicle_profit, String sheet_name) throws InterruptedException, UnsupportedFlavorException, IOException
	{
        ...
        obj_read_excel_calculation_page = new ReadExcelCalculationForPurchaseAgreement();
        double monthly_total_payment_expected_from_excel= obj_read_excel_calculation_page.get_monthly_finance_payment_after_editing_vehicle_profit(vehicle_additional_discount_copied, sheet_name);
        ExplicitWait.visibleElement(driver, customer_quote_monthly_finance_rental, 30);
        double monthly_total_payment_actual_from_screen=Double.parseDouble(RemoveComma.of(customer_quote_monthly_finance_rental.getText().trim().substring(2)));
	...
	public boolean check_monthly_finance_payment_after_making_balloon_payment_off(String sheet_name ) throws InterruptedException, IOException
	{
		...
		double monthly_finance_payment_expected_from_excel =  obj_read_excel_calculation_page.get_monthly_finance_payment_after_making_balloon_payment_off( sheet_name);
	...
	public boolean check_monthly_total_payment_after_making_balloon_payment_off_with_maintenance(String sheet_name ) throws InterruptedException, IOException
	{
		Click.on(driver, balloon_payment_toggle, 40);
		...
		double monthly_total_payment_expected_from_excel =  obj_read_excel_calculation_page.get_monthly_total_payment_after_making_balloon_payment_off( sheet_name);
	...
	public boolean check_monthly_total_payment_after_making_balloon_payment_off(String sheet_name ) throws InterruptedException, IOException
	{
		Click.on(driver, balloon_payment_toggle, 40);
