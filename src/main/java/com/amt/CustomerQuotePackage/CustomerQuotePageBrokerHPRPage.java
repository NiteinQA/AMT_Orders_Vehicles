...
public class CustomerQuotePageBrokerHPRPage extends TestBase {
	...
	@FindBy(xpath = "//*[@id='headingHprSummary']/button/div")
	private WebElement customer_quote_summary;
		
	                 
	@FindBy(xpath = "//*[@id='collapseCustomerQuote']/div/div/div/div/div/div/div/app-broker-hpr-customer-quote-summary-detail/div/div[7]/div/p/strong")
