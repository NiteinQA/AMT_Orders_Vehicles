...
public class CustomerQuotePageBrokerBCHPage extends TestBase {
	...
	public boolean customer_Quote_broker_bch_with_maintenance( String quoteRef, String quoteExpiryDate, String term, String milesperannum, 
...
//		else {Click.on(driver, maintenance_toggle_button, 20);}
	...
	public boolean customer_Quote_broker_bch_without_maintenance( String quoteRef, String quoteExpiryDate, String term, String milesperannum, 
