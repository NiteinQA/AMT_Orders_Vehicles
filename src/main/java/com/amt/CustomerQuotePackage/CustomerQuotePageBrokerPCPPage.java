...
public class CustomerQuotePageBrokerPCPPage extends TestBase {
	...
	@FindBy(xpath = "//div[@id='headingPcpSummary']//button[@type='button']//div[1]")
	private WebElement customer_quote_summary;
		
	@FindBy(xpath = "//*[@id=\"collapseCustomerQuote\"]/div/div/div/div/div/div/div/app-broker-pcp-customer-quote-summary-detail/div/div[7]/div/p/strong")
...
//	}
	...
	public boolean customer_Quote_broker_pcp_without_maintenance(String vehicleProfit,String quoteRef, String quoteExpiryDate, String term,
		...
		System.out.println("otr price from excel "+on_road_price_for_invoice);
		...
		System.out.println("otr_screen_price_converted "+otr_screen_price_converted);
		...
		if(balance_to_finance_status&&vehicle_profit_status && diff<0.2 && save_button.isEnabled() )
		{
			status=true;
